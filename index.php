      ...
      <div class="container row">
        ...
        >
          <div class="col-md-4" style="cursor: pointer">
            <div
              class="product-card"
              onclick="window.location.href='/inspecionarProducto.html'"
            >
              <img
                class="img-fluid"
                src="/img/GalloTienda1.jpg"
                alt="Producto 1"
                class="product-image"
              />
              ...
              <div class="d-flex justify-content-center">
                <button
                  type="button"
                  class="botones btn"
                  onclick="alert('Botón presionado! Jajajajaa *_*'); event.stopPropagation();"
                >
                  <img class="img-flu" src="/icons/shoping-cart.svg" alt="" />
                </button>
              </div>
