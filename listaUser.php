...
<body>
  ...
  <!-- Verifica si la clave 'error' está definida antes de intentar acceder a su valor -->
  
  <?php if (isset($_GET['error']) && $_GET['error'] == 'delete-yourself') : ?>
    <div class="alert alert-danger text-center" role="alert">¡No puedes borrarte tú mismo!</div>
  <?php endif; ?>

  <!-- Verifica si la clave 'success' está definida antes de intentar acceder a su valor -->

  <?php if (isset($_GET['success']) && $_GET['success'] == 'deleted') : ?>
    <div class="alert alert-success text-center" role="alert">¡Usuario eliminado exitosamente!</div>
  <?php endif; ?>
