  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6 mx-lg-auto">
        ...
        <?= $_GET['message'] =='updated'?'<div class="alert alert-success text-center" role="alert">Usuario editado exitosamente!</div>' : ''; ?>
          ...
          <div class="align-content-center text-lg-start p-4">
            ...
            <div class="d-flex justify-content-center p-3">
              <a href="/editarUserAdmin.php?php echo $userId; ?>"><button id="submit" type="button" class="btn" style=" border-color:black; color: black;">
