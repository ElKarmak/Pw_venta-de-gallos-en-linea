        ...
        <tbody>
            <tr class="align-middle">
              ...
              <td>
                <div class="align-middle text-center">
                  <input
                    class="form-control form-control-lg-sm"
                    type="number"
                    value="3"
                  />
                </div>
              </td>
              <td>Gallo de combate</td>
              <td class="d-flex flex-column align-items-center">
                <div class="mb-3">
                  <a href="/editarProducto.html" style="text-decoration: none">
                    <button
                      type="button"
                      class="botones btn-primary btn btn-danger text-black"
                    >
                ...
                <div>
                  <a href="#" style="text-decoration: none">
                    <button
                      type="button"
                      class="btn btn-danger m-3 text-black"
                    >
            ...
            <tr class="align-middle">
              ...
              <td class="d-flex flex-column align-items-center">
                <div class="mb-3">
                  <a href="/editarProducto.html" style="text-decoration: none">
                    <button type="button" class="botones btn btn-danger text-black">
                      <img class="img-flu" src="/icons/IconUpdate.svg" alt="">
                    </button>
                  </a>
                </div>
